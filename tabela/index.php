...
<head>
  <meta charset="UTF-8">
  <title>PainelCheckers© -TABELA</title>
...
<script type="text/javascript" src="http://static.tumblr.com/xpo2exu/Ulamus7t3/efeito_ghosting.js"></script>
...
<div id="price">
  ...
  <div class="plan">
    <div class="plan-inner">
      <div class="entry-title">
        <h3>+VIP+</h3>
        <div class="price">$30<span>1 Mês</span>
        </div>
      </div>
      <div class="entry-content">
        <ul>
          <li><strong>PREMIUM</strong> Ferramentas</li>
          <li><strong>PREMIUM</strong> Checkers de lojas</li>
          <li><strong>PREMIUM</strong> Checker de assinaturas</li>
          <li><strong>PREMIUM</strong> Geradores</li>
          <li><strong>PREMIUM</strong> Checker de cc</li>
        </ul>
      </div>
      <div class="btn">
        <a href="https://t.me/natyy1777">Comprar</a>
      </div>
    </div>
  </div>
  <!-- end of price tab-->
  ...
  <div class="plan basic">
    <div class="plan-inner">
      <div class="hot">Promoção</div>
      <div class="entry-title">
        <h3>+VIP+</h3>
        <div class="price">$50<span>2 Mês</span>
        </div>
      </div>
      <div class="entry-content">
        <ul>
          <li><strong>PREMIUM</strong> Ferramentas</li>
          <li><strong>PREMIUM</strong> Consultas</li>
          <li><strong>PREMIUM</strong> Checkers de cc</li>
          <li><strong>PREMIUM</strong> Geradores</li>
          <li><strong>PREMIUM</strong> Checkers de lojas</li>
          <li><strong>PREMIUM</strong> Checkers de assinaturas</li>
        </ul>
      </div>
      <div class="btn">
        <a href="https://t.me/natyy1777">Comprar</a>
  ...
  <div class="plan standard">
    <div class="plan-inner">
      <div class="entry-title">
        <h3>+VIP+</h3>
        <div class="price">$80<span>3 Mês</span>
        </div>
      </div>
      <div class="entry-content">
        <ul>
          ...
          <li><strong>PREMIUM</strong> Consultas</li>
          <li><strong>PREMIUM</strong> Checkers de assinaturas</li>
          <li><strong>PREMIUM</strong> Checker de lojas</li>
          <li><strong>PREMIUM</strong> Localizadores</li>
          <li><strong>PREMIUM</strong> Geradores</li>
        </ul>
      </div>
      <div class="btn">
  ...
  <div class="plan ultimite">
    <div class="plan-inner">
      <div class="entry-title">
        <h3>+VIP+</h3>
        <div class="price">$100<span>4 Mês</span>
        </div>
      </div>
      <div class="entry-content">
        <ul>
          ...
          <li><strong>PREMIUM</strong> Checkers de assinaturas</li>
          <li><strong>PREMIUM</strong> Checkers de lojas</li>
          <li><strong>PREMIUM</strong> Ferramentas extras</li>
          <li><strong>PREMIUM</strong> Geradores</li>
          <li><strong>PREMIUM</strong> Localizadores</li>
        </ul>
      </div>
      <div class="btn">
        <a href="https://t.me/pandaoficial">Comprar</a>
      </div>
    </div>
  </div>
  <!-- end of price tab-->
