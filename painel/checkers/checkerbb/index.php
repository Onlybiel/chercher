...
<div class="card col-sm-8">
    <center><h5 class="card-body h6"><h2>Checker Banco do brasil</h2></h5></center>
    <center><h5 class="card-body h6"><h2>#PainelCheckers</h2></h5></center>
  <div class="card-body">
...
<div class="card col-sm-2">
  <div class="card-body">
      <span> STATUS</b> </span><span class="badge badge-secondary"> OK </span>
<div class="md-form">
    <span><b>Aprovadas</b></span>&nbsp<span id="cLive" class="badge badge-success">0</span>
    ...
    <span><b>Carregadas</b></span>&nbsp<span id="carregadas" class="badge badge-dark">0</span>
    <span><b>Hora</b></span>&nbsp<span id="time" class="badge badge-info"></span>
    <div id="time"></div>
<script>
...
<div style="position: absolute;
        top: 0;
        right: 0;">
	<button id="mostra" class="btn btn-primary">MOSTRA</button>
</div>
  <div class="card-body">
