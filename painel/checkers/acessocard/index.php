...
<body><br>
    <center>
      <font size="8">Checker - ACESSO CARD</font> <br />
   <font size="5" class="afs">#PainelCheckers</font>
     <br /><br />
   <textarea id="list" name="lista" rows="5" required="" cols="1" style="max-width: 50rem;" class="form-control" placeholder="Cpf|Senha"></textarea><p></p>
    <div>
