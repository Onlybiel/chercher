...
if (isset($_POST['x'])) {
$busca = _curl('https://api.namefake.com', false, false, false, true);
#echo $busca;
$decoder = json_decode($busca,true);
$nome = $decoder['name'];
$rua = $decoder['address'];
$latitude = $decoder['latitude'];
$longetude = $decoder['longitude'];
$nomess = $decoder['maiden_name'];
$data = $decoder['birth_data'];
$telfonecel = $decoder['phone_h'];
$telefonecasa = $decoder['phone_w'];
$email = $decoder['email_d'];
$usuario = $decoder['username'];
$senha = $decoder['password'];
$useragent = $decoder['useragent'];
$website = $decoder['domain'];
$ipv4 = $decoder['ipv4'];
$mac = $decoder['macaddress'];
$cartao = $decoder['plasticcard'];
$vencimento = $decoder['cardexpir'];
$sangue = $decoder['blood'];
$esporte = $decoder['sport'];
$compania = $decoder['company'];
$altura = $decoder['height'];
$cc = "$cartao - $vencimento";
  ...
  <table class="table table-striped" id="tabAprovadas" name="tabAprovadas">
    <thead>
      <tr>
        ...
        <th><center>Tipo Sanguíneo</center></th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <th><center><?php echo $data; ?></center></th>
        <th><center><?php echo $email; ?></center></th>
        <th><center><?php echo $telfonecel; ?></center></th>
        <th><center><?php echo $sangue; ?></center></th>
        <th><center><?php echo $cc; ?></center></th>
      </tr>
    </tbody>
  </table>
</form>
