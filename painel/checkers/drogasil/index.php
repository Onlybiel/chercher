...
<div class="card col-sm-8">
  <h5 class="card-body h6">CHECKER DROGASIL</h5>
  <div class="card-body">
...
<div style="position: absolute;
        top: 0;
        right: 0;">
	<button id="mostra" class="btn btn-primary">MOSTRA LIVES</button>
</div>
  <div class="card-body">
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">PainelCheckers
