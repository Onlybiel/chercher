...
<div class="card col-sm-8">
  <h5 class="card-body h6">CHK ADFOCUS</h5>
  <div class="card-body">
    <center><span>Painelcheckers</span></span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">FORMATO--->  EMAIL|SENHA</label>
</div>
</div>
<center>
 <button class="btn btn-primary" style="width: 200px; outline: none;" id="testar" onclick="enviar()" >INICIAR</button>
...
<div class="card col-sm-2">
  ...
  <div class="card-body">
  	<span>Status:</span><span class="badge badge-secondary"> Aguardando Iniciar.</span>
<div class="md-form">
...
<div style="position: absolute;
        top: 0;
        right: 0;">
	<button id="mostra" class="btn btn-primary">MOSTRA LIVE</button>
</div>
<div class="card-body">
...
<div class="card">
	<div style="position: absolute;
        top: 0;
        right: 0;">
	<button id="mostra2" class="btn btn-primary">MOSTRA DIE</button>
</div>
  <div class="card-body">
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">Painelcheckers></a>
    </div>
                      CANAL YOUTUBE https://www.youtube.com/channel/UC-A9OaKvhDmggpr6d5BDVaw
