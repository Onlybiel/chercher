...
<title>Checker - GLOBO PLAY</title>
<style>
...
<script>
        var audio = new Audio('blop.mp3');
            $(document).ready(function () {
                $('#status').html('<span id="bad" class="badge badge-danger">Carregando !</span>');
...
<body><br>
    <center>
      <font size="8">Checker - GLOBO PLAY</font> <br />
   <font size="5" class="afs">#PainelCheckers</font>
     <p></p>
     <font size="5" class="afs">Coder: @PandaOficial</font>
     <br /><br />
   <textarea id="list" name="lista" rows="5" required="" cols="1" style="max-width: 50rem;" class="form-control" placeholder="Email|Senha"></textarea><p></p>
    <div>
...
<div class="button-list">
    <button class="btn btn-success" type="submit" id="start">TESTAR</i></button>
    <button class="btn btn-danger" type="submit" id="stop">PARAR</button>
  </div>
   <br /><br />

<center>
    <div class="card border- mb-3" style="max-width: 45rem;">
      <div class="card-header"><i class="far fa-thumbs-up"></i> APROVADAS <i class="far fa-thumbs-up"></i></div>
      <div id="aprovadas" class="card-body"></div>
    </div><br><br>

    <div class="card border- mb-3" style="max-width: 45rem;">
       <div class="card-header"><i class="far fa-thumbs-down"></i> REPROVADAS <i class="far fa-thumbs-down"></i></div>
